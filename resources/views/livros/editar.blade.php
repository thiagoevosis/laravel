            ...
            <div class="modal-body">
                <form>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="exampleFormControlSelect1">Formato      {{ $tipo}}  </label>
                                <select class="form-control" wire:model="tipo"  id="tipo">
                                   <option value="Digital">Digital</option>
                                   <option value="Impresso">Impresso</option>
                                   {{-- <option value="{{ old('1') == '1' ? 'selected' : ($tipo == '1' ? 'selected' : '') }}">FiSICO</option> --}}
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="id_categoria"wire:model="id_categoria">
                                @if (!empty($categorias))
